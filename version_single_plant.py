...
def main():
    ...
    ab_fill = pcv.fill(bin_img=ab, size=1500)
        #print("filled")
    ...
    new_im.save("subset//" + args.filename + "last_masked.png")
    ...
    new_im.save("subset//" + args.filename + "shape_img.png")
    ...
    new_im.save("subset//" + args.filename + "boundary_img.png")
...
### Analysis ###
    ...
    new_im = Image.fromarray(shape_img)
    new_im.save("subset//" + args.filename + "shape_img_side.png")
...
for item in side_files:
    ...
    args.outdir = "C:\\Users\\RensD\\OneDrive\\studie\\Master\\The_big_project\\subset\\"
    args.writeimg = True
    args.result = "subset//" + side_files_names[file_counter][0:-4] + "side_results.txt"
